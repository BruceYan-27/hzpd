	...
	<gui-page :customHeader="true">
		...
		<template v-slot:gBody>
			...
			<view class="gui-margin-top gui-padding-x">
				<text class="gui-text gui-secondary-text">GraceUI 是一套基于 uni-app 的优秀前端框架，提供了极其丰富的组件、布局、界面及模板，会大幅度提高您的前端布局速度。\n\n
GraceUI 来自于近6年上百个小程序及APP项目的总结。我们是一线开发者，更深度地参与项目开发，所以能够为您提供更好的框架。\n\n
GraceUI 使用用户过万，通过1万+开发者的反馈加上我们长期的高频更新，框架已经极其稳定，兼容性极好！\n\n
GraceUI 第一版发布于 2018年09月，4年多来我们一直坚持聆听并快速响应，快速更新，目前已经更新到 6.0 版本，因为努力更值得信赖。\n\n
